...
export default function LoginPage() {
  ...
  async function onSubmit(data: LoginInput) {
    ...
    try {
      ...
      // Full page reload to establish session cookie before navigation
    ...
    <div>
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center">
          <span className="bg-slate-50 px-3 text-xs text-slate-400 font-medium uppercase tracking-wider">
            or
          </span>
        </div>
      </div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 py-2.5 px-4 border border-slate-200 rounded-xl text-sm font-medium text-slate-700 bg-white hover:bg-slate-50 hover:border-slate-300 transition-colors"
      >
